...
_User_otp_secret_OrderByInput = TypedDict(
    '_User_otp_secret_OrderByInput',
    {
...
class UserWhereInput(TypedDict, total=False):
    ...
    otp: Union[_str, 'types.StringFilter']
    otp_secret: Union[_str, 'types.StringFilter']
...
class UserScalarWhereWithAggregatesInput(TypedDict, total=False):
    ...
    otp_secret: Union[_str, 'types.StringWithAggregatesFilter']
